    ...
    <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-4">{t("locationTitle")}</h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">{t("locationSubtitle")}</p>
        </div>
            ...
            <CardContent className="p-0">
              ...
              <div className="p-8 space-y-6">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-2xl font-bold text-foreground">{t("locationName")}</h3>
                ...
                <p className="text-muted-foreground leading-relaxed text-lg">{t("locationDescription")}</p>

                <div className="space-y-3">
                  <p className="text-sm font-medium text-foreground">{t("advantages")} :</p>
                ...
                <div className="pt-6 border-t">
                  <div className="flex items-center justify-between">
                    ...
                    <p className="text-xl font-bold text-cyan-600">
                      {t("startingFrom")} 15 DT{t("perHour")}
                    </p>
                  </div>
                </div>
              </div>
